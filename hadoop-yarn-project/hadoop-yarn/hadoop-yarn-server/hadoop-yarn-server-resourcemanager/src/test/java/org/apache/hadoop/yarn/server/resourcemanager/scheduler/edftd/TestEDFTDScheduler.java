...
public class TestEDFTDScheduler {
  private static final Log LOG = LogFactory.getLog(TestEDFTDScheduler.class);
  ...
  public void setUp() throws Exception {
    ...
    conf.setClass(YarnConfiguration.RM_SCHEDULER, 
        EDFTDScheduler.class, ResourceScheduler.class);
  ...
  @Test(timeout=5000)
  public void testEDFTDSchedulerCapacityWhenNoNMs() {
    EDFTDScheduler scheduler = new EDFTDScheduler();
...
//  @Test
  public void testEDFTDScheduler() throws Exception {

    LOG.info("--- START: testEDFTDScheduler ---");
    ...
    LOG.info("--- END: testEDFTDScheduler ---");
  }

  @Test
  public void testBlackListNodes() throws Exception {
    Configuration conf = new Configuration();
    conf.setClass(YarnConfiguration.RM_SCHEDULER, EDFTDScheduler.class,
        ResourceScheduler.class);
    MockRM rm = new MockRM(conf);
    rm.start();
    EDFTDScheduler fs = (EDFTDScheduler) rm.getResourceScheduler();
  ...
  public static void main(String[] arg) throws Exception {
    TestEDFTDScheduler t = new TestEDFTDScheduler();
    t.setUp();
    t.testEDFTDScheduler();
    t.tearDown();
  }
